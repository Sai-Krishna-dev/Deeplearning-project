...
image_base64 = get_base64_of_image("C:/Users/user/Desktop/final_year_project/COLEAF_MAIN_-main/bg.jpg")
...
if uploaded_file:
    ...
    with col2:
        ...
        if model and label_encoder:
            ...
            if predicted_class:
                st.markdown(f"<p class='prediction'>✅ Detection: {predicted_class}</p>", unsafe_allow_html=True)
